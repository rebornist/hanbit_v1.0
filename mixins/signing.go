...
func CreateAccessJWT(email string) (*JWTToken, *JWTUserInfo, error) {
...
func CreateRefreshJWT(email string) (*JWTToken, *JWTUserInfo, error) {
...
func CheckRefreshToken(c echo.Context, db *gorm.DB) (*JWTUserInfo, error) {
...
func CheckStatus(c echo.Context, db *gorm.DB) (*JWTUserInfo, error) {
...
func initJWT(email string) (*JWTToken, *JWTUserInfo, error) {
	// 유저정보 추출
